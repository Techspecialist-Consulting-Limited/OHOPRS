...
const agencies = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&q=80",
    description: "The National Social Safety Nets Coordinating Office (NASSCO) serves as the central coordinating body for Nigeria's social protection initiatives, with a mandate to identify and support poor and vulnerable households through an integrated national social safety net system. NASSCO builds and maintains the National Social Register, coordinates across institutions and programmes, facilitates targeting and payment systems, and ensures policy coherence across the sector — reaching millions of households through shock-responsive cash transfers and state-level coordination across all 36 states and the FCT.",
    programmes: [
      "National Social Register Development — Nationwide",
      "Shock-Responsive Cash Transfers — NASSP-SU",
    ],
    stats: { beneficiaries: 24, interventions: 2, budget: "₦450M" },
  },
  {
    shortCode: "NPOWER",
    name: "N-Power Programme",
    image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?w=1200&q=80",
    description: "N-Power is the Federal Government's flagship youth empowerment scheme designed to tackle unemployment and enhance public service delivery. Targeting Nigerians aged 18 to 35, N-Power provides job training, skills acquisition, and a monthly stipend across six categories — N-Teach, N-Health, N-Agro, N-Build, N-Creative, and N-Tech — deploying trained graduates and non-graduates to communities nationwide to strengthen education, healthcare, agriculture, and vocational services.",
    programmes: [
      "N-Teach — Education Support Nationwide",
      "N-Health — Primary Healthcare Deployment",
    ],
    stats: { beneficiaries: 8, interventions: 2, budget: "₦300M" },
  },
];
